...
const Card = () => {
  return (
    <div className="cursor-pointer group overflow-hidden p-5 duration-1000 hover:duration-1000 relative w-80 h-72 bg-neutral-800 rounded-xl">
      ...
      <div className="w-full h-full shadow-xl shadow-neutral-900 p-3 bg-neutral-600 opacity-50 rounded-xl flex-col gap-2 flex justify-center">
        <span className="font-bold text-xl italic text-white">Explore More</span>
